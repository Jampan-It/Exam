    ...
    <c:param name="content">
        <section class="me-4">
            ...
            <form method="post" action="SubjectUpdate.action">
                ...
                <div class="mt-3">
                   <button type="button" class="btn btn-primary" onclick="window.location.href='subject_change_done.jsp';">変更</button>

                    <a href="SubjectList.jsp" class="btn btn-secondary">キャンセル</a>
                </div>
            </form>
        </section>
    </c:param>
